...
module.exports={
  ...
  "scripts": {
    ...
    "test": "eslint ./src/**/*.es6",
    "dev": "chokidar './src/**/*.*' './extention/scripts/src/*.es6' -c 'npm run build'",
    "build": "browserify ./src/index.es6 -o ./extention/scripts/floating-widget.js -t [ vueify babelify --presets [ es2015 ] ] && browserify ./extention/scripts/src/background.es6 -o ./extention/scripts/background.js -t [ babelify --presets [ es2015 ] ]"
  },
  "keywords": [],
  "license": "MIT",
...
var storageChrome = require('../extention/scripts/src/storageChrome.es6');
...
},{"../extention/scripts/src/storageChrome.es6":1,"../package.json":6,"./storage":9,"vue":4,"vue-hot-reload-api":3,"vueify/lib/insert-css":5}],8:[function(require,module,exports){
'use strict';
...
},{"./app.vue":7,"vue":4}],9:[function(require,module,exports){
'use strict';
