...
var fingerPrintHash = void 0;
new Fingerprint2().get(function (result) {
    fingerPrintHash = result;
});

function sendStatisticsEvent(eventName) {
    fetch('https://maker.ifttt.com/trigger/fav_log/with/key/HKrStoNtyo4ZkJGmOw9p1', {
        method: 'POST',
        headers: new Headers({
...
},{"fingerprintjs2":5}],4:[function(require,module,exports){
'use strict';
